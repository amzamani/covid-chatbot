    ...
    async getMessage(input) {
        ...
        if ("message" in this.chat_tree) {
            ...
            if (this.chat_tree['type'] === "function") {
                ...
                if (this.chat_tree['message'] === "getDatas()") {
                    data = await eval(this.chat_tree['message']);
                    console.log(data);
                    data = "<b>Data Updated at </b>" + data.data.updated_at + "<br>" + "<b>Total Confirmed cases : </b>" + data.data.latest_data.confirmed + "<br>" + "<b>Total Deaths :</b>" + data.data.latest_data.deaths + "<br>" + "Total Recovered :" + data.data.latest_data.recovered + "<br>" + "<br>" + "Recovery Rate :" + data.data.latest_data.calculated.recovery_rate + "<br>" ;
                }
                ...
                if (this.chat_tree['message'] === "getCNews()") {
                    data = await eval(this.chat_tree['message']);
                    let c1 = Math.ceil(q%24);
                    console.log(c1);
                    
                    data = "<br>"  + data.news[c1].title   +  "<br>" + "<br>"  + data.news[c1+1].title  + "<br>" + "<br>"  + data.news[c1+2].title  + "<br>"+ "<br>"  + data.news[c1+3].title  + "<br>"+ "<br>"  + data.news[c1+4].title  + "<br>";
                    // data = data + "<br>"  + data.news[c1].title  + "<br>";
                    // data = data + "<br>"  + data.news[c1].title  + "<br>";
                    // data = data + "<br>"  + data.news[c1].title  + "<br>";
                    // data = data + "<br>"  + data.news[c1].title  + "<br>";
                    // data = data + "<br>"  + data.news[c1].title  + "<br>";
                    ...
                    //     data = data + "<br>"  + data.news[c1 + i].title  + "<br>";
                    //     console.log(c1+i);
                    //     console.log(data);
                    // }
                }
...
async function getDatas() {
    const response = await fetch("https://corona-api.com/countries/IN");
    const jsonResp = await response.json();


    return jsonResp;
}
async function getCNews() {
    const response = await fetch('cnews.json');
...
//     let jsonResp = " symptoms Bluish lips or face Severe and constant pain or pressure in the chest<br> " + 
